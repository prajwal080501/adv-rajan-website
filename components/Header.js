        ...
        <nav className={darkMode ? 'navbar-dark' : 'navbar'}>
            <div className="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
                ...
                <div className="hidden md:inline-flex items-center space-x-4">
                    <a href="javascript:void(0)" className="py-3 px-4 text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow duration-300 ease">
                        Get Started
                    </a>
                    <SunIcon onClick={handleDarkMode} className='h-6 w-6' />
