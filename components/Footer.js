    ...
    return (
        <footer className={darkMode ? 'footer-dark' : 'footer'}>
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <Link href="/">
                        <a className={darkMode ? "px-5 md:px-0 text-white font-extrabold text-xl md:text-2xl font-arial hover:text-blue-600 duration-200 ease":"px-5 md:px-0 text-black font-extrabold text-xl md:text-2xl font-arial hover:text-blue-600 duration-200 ease"}>
                            Adv Rajan Ladkat
                        </a>
                    </Link>
